...
<StackLayout padding="10 10 0 10">
    <GroupSubtitle ref="subtitle" borderBottomLeftRadius="5" borderBottomRightRadius="5" :visibility="visibility.status" :judul="judul" :bus="bus" class="full-border" @onBubbleTriggered="onBubbleTriggered" />
