...
<StackLayout padding="10 10 0 10">
    <TadarusSubtitle ref="subtitle" borderBottomLeftRadius="5" borderBottomRightRadius="5" :visibility="visibility.status" :bus="bus" class="full-border" @onBubbleTriggered="onBubbleTriggered" />
