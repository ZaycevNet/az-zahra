...
<template>
    <GridLayout @loaded="onLoaded" rows="25, auto, *" marginBottom="5">
      ...
      <TextView row="1" ref="textField" height="150" :text="text" fontSize="14" @focus="onFocus" @textChange="onTextChange" @blur="onBlur" borderWidth="1" borderColor="#cec8c8" padding="5" backgroundColor="rgba(0, 180, 126, 0)" />
