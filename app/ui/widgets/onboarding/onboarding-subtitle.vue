<template>
    ...
    <StackLayout backgroundColor="#28ADAA" color="white">
        <GridLayout columns="*,40%,40%" rows="*" height="auto" padding="10 5">
            <StackLayout col="0" >
              <Label textAlignment="left" fontWeight="bold" paddingLeft="10" fontSize="16px" verticalAlignment="left" :text="judul | capitalize" textWrap="true"/>
