...
<StackLayout padding="10 10 0 10">
    <ZisSubtitle ref="subtitle" borderBottomLeftRadius="5" borderBottomRightRadius="5" :visibility="visibility.status" :jenis="jenis" :bus="bus" class="full-border" @onBubbleTriggered="onBubbleTriggered" />
