	...
	<GridLayout rows="25, auto, *" marginBottom="10" marginTop="5">
			<Label ref="label" row="1" :text="placeholder" opacity="0.4"
					...
					<GridLayout ref="textField" row="1" class="segment" @loaded="onLoad" width="100%" rows="*" columns="*,*,*" >
						...
						<StackLayout col="1" class="segment-left" horizontalAlignment="right" >
						...
						<StackLayout col="2" horizontalAlignment="right" >
							<Ripple @tap="onTap(2)" width="100%" rippleColor="#28BAAA">
								<StackLayout ref="segment2">
									<Label padding="10 0" horizontalAlignment="center" text="Orang Lain" />
								</StackLayout>
							</Ripple>
						</StackLayout>
			    </GridLayout>
