						...
						<StackLayout col="0" class="segment-left" horizontalAlignment="left" >
							<Ripple @tap="onTap(0)" width="100%" rippleColor="#28BAAA">
								<StackLayout ref="segment0" backgroundColor="red" >
									<Label padding="10 0" horizontalAlignment="center" text="Bacaan Islami" />
								</StackLayout>
							</Ripple>
						</StackLayout>
						<StackLayout col="1" horizontalAlignment="right" >
							<Ripple @tap="onTap(1)" width="100%" rippleColor="#28BAAA">
								<StackLayout ref="segment1" backgroundColor="red">
									<Label padding="10 0" horizontalAlignment="center" text="Bacaan Umum" />
								</StackLayout>
							</Ripple>
						</StackLayout>
			    </GridLayout>

					<!-- <Label ref="label" paddingBottom="2.5" rowSpan="2" :text="placeholder" opacity="0.4" verticalAlignment="middle" fontSize="14" class="input" /> -->
