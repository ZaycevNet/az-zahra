<template>
    ...
    <StackLayout backgroundColor="#28ADAA" color="white">
        <GridLayout columns="*,40%,40%" rows="*" height="auto" padding="10 5">
            <Label textAlignment="left" paddingLeft="10" fontSize="16px" verticalAlignment="left" text="Dibuat: 21-10-2020 21:30" textWrap="true" col="0" />
...
export default {
  mixins: [accordionItemFirstLoad],
	...
	// computed: {
	// 	counter(){
	// 		return this.get_habit_organisasi_payload_checked+'/'+this.get_habit_organisasi_payload_length;
	// 	}
	// },
  mounted(){
    // +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
