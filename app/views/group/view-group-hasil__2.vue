    ...
    <Gradient direction="top down" colors="#28ADAA, #28BAAA, #28BAAA, #28BAAA, #28BAAA, #28BAAA, #28BAAA, #28BAAA, #28BAAA, #28BAAA, #28BAAA, #28BAAA, #28BAAA, #28BAAA">
        ...
        <!-- <StackLayout v-if="!rendering0"> -->
            ...
            tabTextColor="rgb(255,255,255,0.5)" tabBackgroundColor="#28BAAA" iosIconRenderingMode="alwaysOriginal">
                ...
                <TabViewItem title="Hari Ini" bageValue="" wrapContent="false">
                    <!-- <ScrollView ref="scroll0" @scroll="onScroll($event, 0)" height="100%" scrollBarIndicatorVisible="false"> -->
                        ...
                        <StackLayout id="stackList0" ref="stackList0" paddingBottom="0" >
                          <!-- <PageGroupHasilSiswa v-if="tab0" :items="get_group_hasil_siswa_payload" class="tabviewitem-container" /> -->
                <PageGroupHasil :items="get_group_hasil_payload.payload_anggota" />
                          <!-- <ActivityIndicator ref="indicator0" color="#28ADAA" :busy="busy0" @busyChange="onBusyChange($event, 0)" /> -->
                        </StackLayout>
                    <!-- </ScrollView> -->
                </TabViewItem>
                <TabViewItem title="Semua" bageValue="" wrapContent="false">
                  ...
                  <!-- <ScrollView ref="scroll1" @scroll="onScroll($event, 1)" height="100%" scrollBarIndicatorVisible="false"> -->
                    ...
                    <StackLayout id="stackList1" ref="stackList1" paddingBottom="30" >
                      <!-- <PageGroupHasilSiswa v-if="tab1" :items="get_habit_membaca_umum_payload" class="tabviewitem-container" /> -->
