...
<Page actionBarHidden="false">
    <ActionBar color="white">
        <GridLayout width="100%" columns="auto, *, 60%">
          <Ripple @tap="onBack" rippleColor="#28ADAA">
            ...
            <Label @tap="onBack" class="action-bar-title" text="Anggota Kelompok" col="1" />
    ...
    <StackLayout @loaded="onLoaded_Rendering(0, 400)">
        ...
        <GroupHeadlineAnggota habit="Anggota Kelompok"  />
        ...
        <GridLayout ref="container" rows="*,auto" v-if="!rendering0" @loaded="onLoaded_Rendering(1, 250)" >
            ...
            <!-- <ScrollView ref="scroll" @scroll="onScroll" height="100%" v-if="!rendering1"> -->
                <StackLayout id="stackList" ref="stackList" paddingBottom="0">
                    ...
                    <PageGroupAnggota :items="get_group_anggota_payload.payload_anggota"  />
...
export default {
    ...
    mounted() {
      console.log("get_group_anggota_payload.payload_anggota", this.get_group_anggota_payload.payload_anggota)
