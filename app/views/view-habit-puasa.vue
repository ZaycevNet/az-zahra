...
<Page actionBarHidden="false">
    ...
    <StackLayout @loaded="onLoaded_Rendering(0, 400)">
        ...
        <ZisHeadline habit="Puasa" />

        <GridLayout ref="container" rows="*,auto" v-if="!rendering0" @loaded="onLoaded_Rendering(1, 100)" >
        <!-- <StackLayout v-if="!rendering0"> -->
            ...
            tabTextColor="rgb(255,255,255,0.5)" tabBackgroundColor="#28BAAA" iosIconRenderingMode="alwaysOriginal">
                ...
                <TabViewItem title="Rutin" bageValue="" wrapContent="false">
                    <StackLayout>
                      ...
                      <TabViewItem title="Senin Kamis" bageValue="" wrapContent="false">
                        <ScrollView ref="scroll_child_0" @scroll="onScrollChild($event, 0)" height="100%" scrollBarIndicatorVisible="false">
                          <StackLayout id="stackList_child_0" ref="stackList_child_0" paddingBottom="30" >
                            ...
                            <PageHabitPuasa v-if="tab_child_0" :items="get_habit_puasa_rutin_payload" class="tabviewitem-container" />
                      ...
                      <TabViewItem title="Puasa Daud" bageValue="" wrapContent="false">
                        ...
                        <ScrollView ref="scroll_child_1" @scroll="onScrollChild($event, 1)" height="100%" scrollBarIndicatorVisible="false">
                          <StackLayout id="stackList_child_1" ref="stackList_child_1" paddingBottom="30" >
                            ...
                            <PageHabitPuasa v-if="tab_child_1" :items="get_habit_puasa_rutin_payload" class="tabviewitem-container" />
                ...
                <TabViewItem title="Khusus" bageValue="" wrapContent="false">
                    <ScrollView ref="scroll1" @scroll="onScroll($event, 1)" height="100%" scrollBarIndicatorVisible="false">
                      <StackLayout id="stackList1" ref="stackList1" paddingBottom="30" >
                        ...
                        <PageHabitPuasa v-if="tab1" :items="get_habit_puasa_khusus_payload" class="tabviewitem-container" />
                ...
                <TabViewItem title="Nazar" bageValue="" wrapContent="false">
                    <ScrollView ref="scroll2" @scroll="onScroll($event, 2)" height="100%" scrollBarIndicatorVisible="false">
                      <StackLayout id="stackList2" ref="stackList2" paddingBottom="30" >
                        ...
                        <PageHabitPuasa v-if="tab2" :items="get_habit_puasa_nazar_payload" class="tabviewitem-container" />
                ...
                <TabViewItem title="Kafarat" bageValue="" wrapContent="false">
                    <ScrollView ref="scroll3" @scroll="onScroll($event, 3)" height="100%" scrollBarIndicatorVisible="false">
                      <StackLayout id="stackList3" ref="stackList3" paddingBottom="30" >
                        ...
                        <PageHabitPuasa v-if="tab3" :items="get_habit_puasa_kafarat_payload" class="tabviewitem-container" />
