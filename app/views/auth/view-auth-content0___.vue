...
<StackLayout @loaded="onLoaded_Rendering(0, 400)">
    ...
    <StackLayout v-if="!rendering0">
        ...
        tabTextColor="rgb(255,255,255,0.5)" tabBackgroundColor="#28BAAA" iosIconRenderingMode="alwaysOriginal">
            ...
            <TabViewItem title="Login" bageValue="" wrapContent="false">
              <StackLayout padding="20">
                <!-- <StackLayout padding="0"> -->
                <AuthNewTextfield placeholder="Telpon" text="" />
                <AuthNewTextfield placeholder="Telpon" text="" />
                <AuthNewTextfield placeholder="Telpon" text="" />
              <!-- </StackLayout> -->
              </StackLayout>

                <!-- <PageAuthLogin v-if="tab0" :items="get_profile_guru_payload.payload_biodata"/> -->

            </TabViewItem>

            <TabViewItem title="Lupa Password" bageValue="" wrapContent="false">
              <StackLayout>
                <AuthNewTextfield placeholder="Telpon" text="" />
                <AuthNewTextfield placeholder="Telpon" text="" />
                <AuthNewTextfield placeholder="Telpon" text="" />
...
export default {
    ...
    methods: {
            ...
            onTabViewLoaded(args) {
                ...
                if(!isIOS) {
                  // args.object.android.tabLayout.setBackgroundResource(0);
                  //
                  ...
                  this.$refs.tabView.nativeView.android.removeViewAt(1);
                } else {
                  this.$refs.tabView.ios.tabBar.hidden = true;
                }
