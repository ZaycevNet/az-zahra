...
<b>This</b> post will show you how to call into Azure Mobile Services using a custom NativeScript module to pull a list of items stored in an Azure SQL database.
