...
<StackLayout @loaded="onLoaded_Rendering(0, 250)">
  ...
  <GridLayout class="search-bar" rows="auto" columns="*,*,*" padding="0 25" >

      <GroupPopupFilterSiswa class="left-border" width="100%" row="0" col="0" />
      <GroupPopupCalenderSiswa class="left-border" width="100%" row="0" col="1" />
      <GroupPopupRankingSiswa class="left-border right-border" width="100%" row="0" col="2" />
