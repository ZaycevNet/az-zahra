...
<StackLayout @loaded="onLoaded_Rendering(0, 250)">
    <ZisAccordion v-if="!rendering0" v-for="(item, index) in items" :key="index" :index="index" :jenis="'sedekah '+item.jenis | capitalize">
        <StackLayout slot="item">
            <Gradient direction="top down" colors="#28ADAA, #28BAAA">
                <StackLayout padding="0 0 10 0">

                    <ZisItemTextbox title="Perantara" :description="item.perantara" />
                    <ZisItemTextbox title="Penerima" :description="item.penerima" />
                    <ZisItemTextbox title="Penghasilan" :description="item.materi" />
                    <ZisItemTextbox title="Presentase" :description="item.presentase" />
                    <ZisItemTextbox title="Tempat" :description="item.tempat" />
                    <ZisItemTextbox title="Tujuan" :description="item.tujuan" />
