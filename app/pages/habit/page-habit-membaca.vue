...
<StackLayout @loaded="onLoaded_Rendering(0, 250)">
    <MembacaAccordion v-if="!rendering0" v-for="(item, index) in items" :key="index" :index="index">
        <StackLayout slot="item">

            <Gradient direction="top down" colors="#28ADAA, #28BAAA">
                <StackLayout padding="0 0 10 0">

                    <MembacaItemTextbox title="Tempat" :description="item.tempat" />
                    <MembacaItemTextbox title="Waktu Mulai" :description="item.waktu" />
                    <MembacaItemTextbox title="Waktu Selesai" :description="item.waktu" />
                    <MembacaItemTextbox title="Topik" :description="item.topik" />
                    <MembacaItemTextbox title="Durasi" :description="item.durasi" />
                    <MembacaItemTextbox title="Rangkuman" :description="item.rangkuman" />
                </StackLayout>
            </Gradient>
