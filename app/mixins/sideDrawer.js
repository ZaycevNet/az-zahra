...
module.exports = {
    ...
    methods: {
        ...
        closeDrawer: _.debounce(function() {
            this.drawer = false
        }, 150),
        onClosedDrawerTriggered(evt) {
            this.drawer = false
                // console.log(evt)
        },

    		onOpeningLeftDrawerTriggered(arg) {
    		  // trigger when sidedrawer opening
    		},
    		onClosedLeftDrawerTriggered(arg) {
    		  // trigger when sidedrawer closed
    		},
    		onClosingLeftDrawerTriggered(arg) {
