...
<Page>
    ...
    <StackLayout>
        ...
        <AdabHeadline :habit="$store.getters.get_habit_adab" />
        <StackLayout v-if="!rendering">
            ...
            tabTextColor="rgb(255,255,255,0.5)" tabBackgroundColor="#28BAAA" iosIconRenderingMode="alwaysOriginal">
                ...
                <TabViewItem v-for="(item, index) in $store.getters.items_payload_habit.payload_title" :key="index" :title="item.title" bageValue="" wrapContent="false">
...
from "nativescript-plugin-statusbar";
